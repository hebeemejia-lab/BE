module.exports = {
  subject: "Ahorro Exclusivo: ¡Descubre cómo ahorrar de forma segura y rentable!",
  html: `
      ...
      <div style="max-width: 600px; margin: auto; background: #fff; border-radius: 16px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); overflow: hidden;">
        <div style="background: linear-gradient(90deg, #1976d2 0%, #43a047 100%); padding: 32px 0; text-align: center;">
          <div style="display: flex; flex-direction: column; align-items: center;">
            ...
            <h2 style="color: #fff; margin: 0; font-size: 28px;">Ahorro Exclusivo</h2>
          </div>
        </div>
        <div style="padding: 32px;">
          <p style="font-size: 17px; color: #222; margin-bottom: 18px;">¿Buscas una forma segura y rentable de ahorrar? En <b>BE</b> te ofrecemos una solución innovadora para que tu dinero crezca y esté siempre protegido.</p>
          <ul style="font-size: 16px; color: #333; margin-bottom: 18px;">
            <li><b>Rentabilidad garantizada</b> desde el primer mes</li>
            <li><b>Flexibilidad</b> para retirar tu dinero cuando lo necesites</li>
            <li><b>Sin comisiones ocultas</b> ni sorpresas</li>
            <li><b>Acceso a asesoría financiera</b> personalizada</li>
          </ul>
          <a href="https://www.bancoexclusivo.lat/ahorro" style="display: inline-block; background: #1976d2; color: #fff; padding: 14px 32px; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 16px; margin-bottom: 18px;">Más información</a>
        </div>
